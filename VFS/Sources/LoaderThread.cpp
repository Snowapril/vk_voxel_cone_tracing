...
namespace vfs
{
    ...
    void LoaderThread::loaderWorker(const char* scenePath)
    {
        ...
        std::shared_ptr<vfs::SparseVoxelizer> voxelizer = std::make_shared<vfs::SparseVoxelizer>(_device, scene, _octreeLevel);
        ...
        std::cout << "Total Voxelization time : " << static_cast<double>(results[3] - results[0]) * 0.000001 << " (ms)\n";
        std::cout << "Voxel fragment list building time : " << static_cast<double>(results[3] - results[2]) * 0.000001 << " (ms)\n";
        std::cout << "Sparse voxel octree building time : " << static_cast<double>(results[1] - results[0]) * 0.000001 << " (ms)\n";
