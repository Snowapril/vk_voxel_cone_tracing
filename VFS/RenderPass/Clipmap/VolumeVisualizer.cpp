...
namespace vfs
{
	...
	VolumeVisualizer& VolumeVisualizer::createPipelines(VkRenderPass renderPass)
	{
		...
		_avcPipeline->attachShaderModule(VK_SHADER_STAGE_VERTEX_BIT,	"Shaders/avc_volume.vert.spv", nullptr);
		_avcPipeline->attachShaderModule(VK_SHADER_STAGE_GEOMETRY_BIT,	"Shaders/avc_volume.geom.spv", nullptr);
		_avcPipeline->attachShaderModule(VK_SHADER_STAGE_FRAGMENT_BIT,	"Shaders/avc_volume.frag.spv", nullptr);
